...
from cogelot.data.templating.replacer import TemplateReplacer
...
class PerTaskTemplateReplacer:
    """Instantiate all the per-task template replacers."""

    def __init__(self, *, allow_original_reuse: bool = True) -> None:
