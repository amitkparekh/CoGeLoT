...
class TexturePedia(Enum):
    ...
    Texture(color) could be further added from
    ...
    RED_AND_YELLOW_STRIPE = _color_combo_textures_entry("red", "yellow", texture_category="stripe")
    DARK_RED_AND_YELLOW_STRIPE = _color_combo_textures_entry(
        "red", "yellow", dark=True, texture_category="stripe"
    )

    RED_AND_GREEN_STRIPE = _color_combo_textures_entry("red", "green", texture_category="stripe")
    DARK_RED_AND_GREEN_STRIPE = _color_combo_textures_entry(
        "red", "green", dark=True, texture_category="stripe"
    )

    RED_AND_BLUE_STRIPE = _color_combo_textures_entry("red", "blue", texture_category="stripe")
    DARK_RED_AND_BLUE_STRIPE = _color_combo_textures_entry(
        "red", "blue", dark=True, texture_category="stripe"
    )

    RED_AND_PURPLE_STRIPE = _color_combo_textures_entry("red", "purple", texture_category="stripe")
    ...
    GREEN_AND_BLUE_STRIPE = _color_combo_textures_entry("green", "blue", texture_category="stripe")
    ...
    DARK_RED_SWIRL = _single_color_textures_entry("red", dark=True, texture_category="swirl")
    YELLOW_SWIRL = _single_color_textures_entry("yellow", texture_category="swirl")
    DARK_YELLOW_SWIRL = _single_color_textures_entry("yellow", dark=True, texture_category="swirl")
    GREEN_SWIRL = _single_color_textures_entry("green", texture_category="swirl")
    DARK_GREEN_SWIRL = _single_color_textures_entry("green", dark=True, texture_category="swirl")
    BLUE_SWIRL = _single_color_textures_entry("blue", texture_category="swirl")
    DARK_BLUE_SWIRL = _single_color_textures_entry("blue", dark=True, texture_category="swirl")
    PURPLE_SWIRL = _single_color_textures_entry("purple", texture_category="swirl")
    DARK_PURPLE_SWIRL = _single_color_textures_entry("purple", dark=True, texture_category="swirl")
    ...
    CYAN = TextureEntry(name="cyan", color_value=(118.0 / 255.0, 183.0 / 255.0, 178.0 / 255.0))
    OLIVE = TextureEntry(name="olive", color_value=(128.0 / 255.0, 128.0 / 255.0, 0.0 / 255.0))
    ...
    def lookup_closest_color(cls, rgb: Tuple[float, float, float]) -> TextureEntry:
        ...
        return [e.value for e in cls][
            np.argmax(np.linalg.norm(rgb - all_defined_color_values, ord=2, axis=-1), axis=0)
        ]
