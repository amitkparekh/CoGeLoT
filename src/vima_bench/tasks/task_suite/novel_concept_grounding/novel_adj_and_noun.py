...
class NovelAdjAndNoun(NovelAdj):
    ...
    An extension to the novel adjective task (drag the blicker obj into the obj) by also
    introducing novel object names.
    """
    ...
    def _reset_prompt(self) -> bool:
        ...
        prompt_template = prompt_template.replace("{dragged_obj}", novel_name_dragged_obj)
